...
-- ----------------------------
INSERT INTO `lvyecms_config` VALUES ('1', 'sitename', '网站名称', '1', 'LvyeCMS内容管理系统');
INSERT INTO `lvyecms_config` VALUES ('2', 'siteurl', '网站网址', '1', '/');
INSERT INTO `lvyecms_config` VALUES ('3', 'sitefileurl', '附件地址', '1', '/d/file/');
INSERT INTO `lvyecms_config` VALUES ('4', 'siteemail', '站点邮箱', '1', 'ad@qq.com');
INSERT INTO `lvyecms_config` VALUES ('6', 'siteinfo', '网站介绍', '1', 'LvyeCMS网站管理系统,是一款完全开源免费的PHP+MYSQL系统.核心采用了Thinkphp框架等众多开源软件,同时核心功能也作为开源软件发布');
INSERT INTO `lvyecms_config` VALUES ('7', 'sitekeywords', '网站关键字', '1', 'LvyeCMS内容管理系统');
INSERT INTO `lvyecms_config` VALUES ('8', 'uploadmaxsize', '允许上传附件大小', '1', '20240');
INSERT INTO `lvyecms_config` VALUES ('9', 'uploadallowext', '允许上传附件类型', '1', 'jpg|jpeg|gif|bmp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip|swf');
...
INSERT INTO `lvyecms_menu` VALUES ('38', '在线云平台', '37', 'Admin', 'Cloud', 'index', '', '0', '1', '', '0');
INSERT INTO `lvyecms_menu` VALUES ('39', '模块商店', '38', 'Admin', 'Moduleshop', 'index', '', '1', '1', '', '0');
INSERT INTO `lvyecms_menu` VALUES ('40', '插件商店', '38', 'Admin', 'Addonshop', 'index', '', '1', '1', '', '0');
INSERT INTO `lvyecms_menu` VALUES ('41', '在线升级', '38', 'Admin', 'Upgrade', 'index', '', '1', '0', '', '0');
