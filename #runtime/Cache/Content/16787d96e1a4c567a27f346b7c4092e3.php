...
<?php } ?>
  ...
  <form class="J_ajaxForms" name="myform" id="myform" action="<?php echo U("Category/add");?>" method="post">
      ...
      <div>
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              <th>栏目缩略图：</th>
              <td><?php  echo call_user_func_array(array("\Form","images"),array('0'=>'info[image]','1'=>'image','2'=>'','3'=>'content',)); ?><span class="gray"> 双击可以查看图片！</span></td>
            </tr>
            <tr>
              <th>栏目简介：</th>
          ...
          <table width="100%" class="table_form ">
            <tr>
              ...
              <td><select name="setting[page_template]" id="page_template">
                  ...
                  <?php if(is_array($tp_page)): $i = 0; $__LIST__ = $tp_page;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
      ...
      <div style="display:none">
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              <th>栏目页URL规则：</th>
              <td><div style="display:" id="category_php_ruleid"> <?php echo ($category_php_ruleid); ?> </div>
                <div style="display:none" id="category_html_ruleid"> <?php echo ($category_html_ruleid); ?> </div></td>
            </tr>
            ...
            <tr>
              ...
              <td><div class="user_group J_check_wrap">
                  ...
                  <?php if(is_array($Role_group)): $i = 0; $__LIST__ = $Role_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dt>
                    ...
                    <dd>
                      <label><input  class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo ($vo["id"]); ?>"  name="priv_roleid[]" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?>  value="init,<?php echo ($vo["id"]); ?>" ><span>查看</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo ($vo["id"]); ?>" name="priv_roleid[]" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?>  value="add,<?php echo ($vo["id"]); ?>" ><span>添加</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo ($vo["id"]); ?>" name="priv_roleid[]" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?>  value="edit,<?php echo ($vo["id"]); ?>" ><span>修改</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo ($vo["id"]); ?>" name="priv_roleid[]" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?>  value="delete,<?php echo ($vo["id"]); ?>" ><span>删除</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo ($vo["id"]); ?>" name="priv_roleid[]" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?>  value="listorder,<?php echo ($vo["id"]); ?>" ><span>排序</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo ($vo["id"]); ?>" name="priv_roleid[]" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?>  value="push,<?php echo ($vo["id"]); ?>" ><span>推送</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo ($vo["id"]); ?>" name="priv_roleid[]" <?php if( $vo['id'] == 1 ): ?>disabled<?php endif; ?>  value="move,<?php echo ($vo["id"]); ?>" ><span>移动</span></label>
